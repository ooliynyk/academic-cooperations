...
public interface AcademicPublicationDocumentProvider {
	Document getAuthorsPageDocumentByOrganizationId(String organizationId, String pageId) throws DocumentCrawlingException;
	...
	Document getAuthorsDocumentByOrganizationName(String organizationId, String pageId) throws DocumentCrawlingException;
}
